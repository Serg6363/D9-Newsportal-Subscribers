...
from .views import PostList, PostText, PostSearch, PostCreateView, PostUpdateView, PostDeleteView, CategoryText
...
urlpatterns = [
    ...
    path(r'cat/(?P<pk>\d+)/', CategoryText.as_view(), name='cat'),
]
